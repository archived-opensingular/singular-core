...
public class StudioMenuTest {
    ...
    public void testMenuWithTwoItens() throws Exception {
        ...
        studioMenu.add(new ItemMenuEntry(Icon.of("X"), "X", new SimpleUrlMenuView("http://localhost/x")));
        studioMenu.add(new ItemMenuEntry(Icon.of("Y"), "Y", new SimpleUrlMenuView("http://localhost/y")));
    ...
    public void testMenuOneItemAndOneGroup() throws Exception {
        ...
        studioMenu.add(new ItemMenuEntry(Icon.of("Item"), "Item", new SimpleUrlMenuView("http://localhost/item")));
        assertTrue(studioMenu.getChildren().size() == 2);
