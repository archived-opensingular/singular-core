...
public class SingularStudioApplication extends AuthenticatedWebApplication
    ...
    public static SingularStudioApplication get() {
        return (SingularStudioApplication) WebApplication.get();
    }
    ...
    public void init() {
        ...
        new AnnotatedMountScanner().scanPackage("br.net.mirante.singular.studio.view.page.**").mount(this);
    ...
    public Session newSession(Request request, Response response) {
        return new SingularStudioSession(request, response);
    }

    @Override
    protected Class<? extends AbstractAuthenticatedWebSession> getWebSessionClass() {
        return SingularStudioSession.class;
    }
