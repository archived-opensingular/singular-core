...
public class SingularStudioSession extends AuthenticatedWebSession {
    ...
    public SingularStudioSession(Request request, @SuppressWarnings("UnusedParameters") Response response) {
        super(request);
    ...
    public static SingularStudioSession get() {
        return (SingularStudioSession) Session.get();
    }
