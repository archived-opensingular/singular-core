...
public class FlowAuthorizationSpringRest implements IFlowAuthorizationService{
    ...
    public Set<String> listProcessDefinitionsWithAccess(String userCod, AccessLevel accessLevel) {
        Set<String> result = new RestTemplate().getForObject(getConnectionURL(IFlowAuthorizationService.PATH_PROCESS_DEFINITION_WITH_ACCESS,
    ...
    public boolean hasAccessToProcessDefinition(String processDefinitionKey, String userCod, AccessLevel accessLevel) {
        return new RestTemplate().getForObject(getConnectionURL(IFlowAuthorizationService.PATH_PROCESS_DEFINITION_HAS_ACCESS,
    ...
    public boolean hasAccessToProcessInstance(String processInstanceFullId, String userCod, AccessLevel accessLevel) {
        return new RestTemplate().getForObject(getConnectionURL(IFlowAuthorizationService.PATH_PROCESS_INSTANCE_HAS_ACCESS,
