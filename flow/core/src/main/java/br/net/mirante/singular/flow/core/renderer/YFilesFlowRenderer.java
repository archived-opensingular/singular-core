        ...
        try {
            ...
            converter.setCreator((task, graph) -> {
                ...
                if(task.isEnd()){
                    ...
                    node = graph.createNode(new RectD(PointD.ORIGIN, new SizeD(40, 25)),
                            endStyle);
                    graph.addLabel(node, task.getName(), ExteriorLabelModel.SOUTH);
                }else{
                    node = graph.createNode(new RectD(PointD.ORIGIN, new SizeD(96, 60)),
                ...
                if(definicao.getFlowMap().getStartTask().equals(task)){
                    ...
                    INode start = graph.createNode(new RectD(PointD.ORIGIN, new SizeD(40, 25)),
                            startStyle);
            ...
            GraphComponent graphComponent = converter.build().toGraphComponent();
