...
import static br.net.mirante.singular.flow.test.definicao.Peticao.PeticaoTask.AGUARDANDO_ANALISE;
import static br.net.mirante.singular.flow.test.definicao.Peticao.PeticaoTask.AGUARDANDO_GERENTE;
...
import static br.net.mirante.singular.flow.test.definicao.Peticao.PeticaoTask.EM_EXIGENCIA;
