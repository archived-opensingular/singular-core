...
package br.net.mirante.singular.bam.view.page.dashboard;
...
import br.net.mirante.singular.bam.view.component.PortletPanel;
import br.net.mirante.singular.bam.view.page.processo.MetadadosPage;
...
import br.net.mirante.singular.bam.view.page.processo.ProcessosPage;
