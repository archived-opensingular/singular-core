...
import br.net.mirante.singular.bam.wicket.view.component.PortletPanel;
import br.net.mirante.singular.bam.wicket.view.page.processo.MetadadosPage;
...
import br.net.mirante.singular.bam.wicket.view.page.processo.ProcessosPage;
