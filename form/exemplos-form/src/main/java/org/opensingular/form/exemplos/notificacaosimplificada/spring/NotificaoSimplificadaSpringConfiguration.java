...
public class NotificaoSimplificadaSpringConfiguration {
    ...
    public DriverManagerDataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:h2:file:./notificacaodb;AUTO_SERVER=TRUE;mode=ORACLE;CACHE_SIZE=4096;MULTI_THREADED=1;EARLY_FILTER=1;MVCC=TRUE;LOCK_TIMEOUT=15000;");
