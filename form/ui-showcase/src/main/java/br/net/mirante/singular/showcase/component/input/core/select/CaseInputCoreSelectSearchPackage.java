...
public class CaseInputCoreSelectSearchPackage extends SPackage {
    ...
    protected void carregarDefinicoes(PackageBuilder pb) {
        ...
        final STypeString degreeType = tipoMyForm.addCampoString("degree");
        ...
        final STypeComposite<?> planetType = tipoMyForm.addCampoComposto("planet");
        final STypeString id = planetType.addCampoString("id");
        final STypeString nome = planetType.addCampoString("nome");
