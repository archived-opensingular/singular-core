...
public class CaseInputCoreMultiSelectCompositePackage extends SPackage {
    ...
    protected void carregarDefinicoes(PacoteBuilder pb) {
         ...
         */
        STypeComposto<SIComposite> tipoIngrediente = (STypeComposto<SIComposite>) pb.createTipoComposto("tipoIngrediente");
        ...
        STypeLista<STypeComposto<SIComposite>, SIComposite> ingredienteQuimico =
         ...
         * "sku" e "nome".
         */
        STypeComposto<SIComposite> productType = (STypeComposto<SIComposite>) pb.createTipoComposto("product");
        ...
        STypeLista<STypeComposto<SIComposite>, SIComposite> produtos =
