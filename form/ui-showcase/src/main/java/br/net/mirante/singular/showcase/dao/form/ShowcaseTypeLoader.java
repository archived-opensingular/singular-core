...
import br.net.mirante.singular.exemplos.notificacaosimplificada.form.vegetal.SPackageNotificacaoSimplificadaDrogaVegetal;
...
public class ShowcaseTypeLoader extends SpringTypeLoader<String> {
    ...
    public ShowcaseTypeLoader() {
        ...
        add(SPackageNotificacaoSimplificadaDrogaVegetal.class, SPackageNotificacaoSimplificadaDrogaVegetal.NOME_COMPLETO);
