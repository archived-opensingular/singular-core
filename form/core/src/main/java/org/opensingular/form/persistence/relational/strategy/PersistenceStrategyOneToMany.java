...
/**
 * One-to-many strategy for saving/loading SInstance data.
 *
 * @author Edmundo Andrade
 */
public class PersistenceStrategyOneToMany implements PersistenceStrategy {
	public void save(SInstance instance, List<RelationalData> toList) {
		for (SInstance item : instance.getChildren()) {
