...
public class SPackageFormPersistence extends SPackage {
    ...
    public static final AtrRef<STypeString, SIString, String> ATR_TABLE_REF_COLUMN = new AtrRef<>(SPackageFormPersistence.class, "tableRefColumn", STypeString.class, SIString.class, String.class);
    ...
    protected void onLoadPackage(PackageBuilder pb) {
        ...
        pb.createAttributeIntoType(SType.class, ATR_TABLE_REF_COLUMN);
