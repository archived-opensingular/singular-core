...
public class MPacoteCore extends MPacote {
    ...
    public static final AtrRef<MTipoBoolean, MIBoolean, Boolean> ATR_TRIM            = new AtrRef<>(MPacoteCore.class, "trim", MTipoBoolean.class, MIBoolean.class, Boolean.class);
    public static final AtrRef<MTipoBoolean, MIBoolean, Boolean> ATR_EMPTY_TO_NULL   = new AtrRef<>(MPacoteCore.class, "emptyToNull", MTipoBoolean.class, MIBoolean.class, Boolean.class);

    public static final AtrRef<MTipoBoolean, MIBoolean, Boolean> ATR_OBRIGATORIO     = new AtrRef<>(MPacoteCore.class, "obrigatorio", MTipoBoolean.class, MIBoolean.class, Boolean.class);
    public static final AtrRef<MTipoPredicate, MIPredicate, Predicate<MInstancia>> ATR_OBRIGATORIO_FUNCTION = new AtrRef(MPacoteCore.class, "obrigatorioFunction", MTipoPredicate.class, MIPredicate.class, Predicate.class);

    public static final AtrRef<MTipoBoolean, MIBoolean, Boolean> ATR_EXISTS          = new AtrRef<>(MPacoteCore.class, "exists", MTipoBoolean.class, MIBoolean.class, Boolean.class);
    ...
    protected void carregarDefinicoes(PacoteBuilder pb) {
        ...
        pb.createTipoAtributo(MTipo.class, ATR_EXISTS);
        pb.createTipoAtributo(MTipo.class, ATR_EXISTS_FUNCTION);
