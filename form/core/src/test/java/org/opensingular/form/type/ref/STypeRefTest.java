...
public class STypeRefTest extends TestCaseForm {

    public STypeRefTest(TestFormConfig testFormConfig) {
    ...
    public static class CarRef extends STypeRef<Car, SIComposite> {
        @Override
        ...
        @Override
        protected FormRespository<Car, SIComposite> getRepository() {
            ...
            Mockito.when(formRespository.loadAll()).thenReturn(Collections.singletonList(car1));
