...
public class STypeTelefoneNacionalTest {
    ...
    public void testFormat() {
        ...
        assertEquals("(61) 98599-7893", type.format("06198599-7893"));
        ...
        assertEquals("(10) 0010-0001", type.format("(01) 00010-0001"));
    }
    ...
    public void extractTelefoneTest() {
        ...
        assertEquals("9981-7881", type.extractNumber("(01) 09981-7881"));
