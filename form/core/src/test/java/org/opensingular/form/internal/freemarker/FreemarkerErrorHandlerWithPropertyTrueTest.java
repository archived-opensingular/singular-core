...
public class FreemarkerErrorHandlerWithPropertyTrueTest extends TestCaseForm {
    ...
    public FreemarkerErrorHandlerWithPropertyTrueTest(TestFormConfig testFormConfig) {
    ...
    public void setUp() {
        ...
        //Passando true na propriedade, tem a maior precedência.
        System.setProperty(SingularProperties.FREEMARKER_IGNORE_ERROR, "true");        
    }
