...
abstract public class BaseAttachmentPersistenceFilesTest {
    ...
    public static Iterable<Object[]> data1() {
        return Arrays.asList(new Object[][]{
                ...
                {"i".getBytes(Charset.forName("UTF-8")), "042dc4512fa3d391c5170cf3aa61e6a638f84342"}, //Caso importante pelo hash começa com zero
                {"np".getBytes(Charset.forName("UTF-8")), "003fffd5649fc27c0fc0d15a402a4fe5b0444ce7"},
                {"1234".getBytes(Charset.forName("UTF-8")), "7110eda4d09e062aa5e4a390b0a572ac0d2c0220"},
                {"TesteTesteTeste".getBytes(), "ceecae2e6034de45a8303a31e9e96adb37c2443f" },
            { "MiranteMiranteMiranteMirante".getBytes(Charset.forName("UTF-8")), "79244437e10faf670b335edc3e3aada33e6790f8" },
            { "sha1 this string".getBytes(Charset.forName("UTF-8")), "cf23df2207d99a74fbe169e3eba035e633b65d94" },
            { "The quick brown fox jumps over the lazy dog".getBytes(Charset.forName("UTF-8")), "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12" },
