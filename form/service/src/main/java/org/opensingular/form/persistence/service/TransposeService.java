...
public class TransposeService {
    ...
    public List<PeticaoPrimariaDTO> list() {
        return reportDAO.listPeticoesPrimarias(generateSql());
    }
    ...
    public String generateSql() {
        ...
        sb.append("SELECT v.CO_VERSAO_FORMULARIO \n");
        ...
        sb.append("GROUP BY v.CO_VERSAO_FORMULARIO \n");
        sb.append(")");
        sb.append("WHERE 1 = 1 \n");
        sb.append(where);
        return  sb.toString();
