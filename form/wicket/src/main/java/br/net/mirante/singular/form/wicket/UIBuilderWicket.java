...
import br.net.mirante.singular.form.wicket.mapper.FileUploadMapper;
...
public class UIBuilderWicket {
    ...
    static {
        ...
        MAPPER_REGISTRY.registerMapper(MTipoFileUpload.class, /**/MView.class, /*                        */FileUploadMapper::new);
