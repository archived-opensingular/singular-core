...
public class ListBreadcrumbMapper extends AbstractListaMapper {
        ...
        ctx.getContainer().appendTag("div", true, null, new MetronicPanel("panel") {
            ...
            protected void buildContent(BSContainer<?> content, Form<?> form) {
                content.appendTag("table", true, null, (id) -> {
                    BSDataTable<SInstance, ?> bsDataTable = buildTable(id, model, view, ctx, viewMode);
    ...
    private BSDataTable<SInstance, ?> buildTable(String id, IModel<? extends SInstance> model, SViewBreadcrumb view, WicketBuildContext ctx, ViewMode viewMode) {
