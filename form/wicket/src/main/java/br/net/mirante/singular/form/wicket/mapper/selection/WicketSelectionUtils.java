...
public class WicketSelectionUtils {
    ...
    public static List<SelectOption> createOptions(IModel<? extends SInstance2> model, SType<?> type) {
    ...
    private static List<SelectOption> createSelectOptions(IModel<? extends SInstance2> model, MOptionsProvider provider) {
