...
import org.opensingular.form.wicket.mapper.maps.ListLatitudeLongitudeMapper;
...
public class IWicketComponentMapperRegistry
    ...
    private void registerDefaultMapping() {
        ...
        add(STypeLatitudeLongitude.class, SViewCurrentLocation.class,     LatitudeLongitudeMapper::new);
        add(STypeListLatitudeLongitude.class,                                 ListLatitudeLongitudeMapper::new);
