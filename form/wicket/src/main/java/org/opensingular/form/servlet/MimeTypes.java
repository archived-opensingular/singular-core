...
public abstract class MimeTypes {
    ...
    private static final ImmutableMultimap<String, String> EXT_2_MIME_TYPES;
    private static final ImmutableMultimap<String, String> MIME_TYPES_2_EXT;
    ...
    static {
        ...
        EXT_2_MIME_TYPES = builder.build();
        MIME_TYPES_2_EXT = EXT_2_MIME_TYPES.inverse();
    }
    ...
    public static String getMimeTypeForExtension(String extension) {
        return getMimeTypeForExtension(extension, DEFAULT_CONTENT_TYPE);
    }

    public static String getMimeTypeForExtension(String extension, String defaultMimeType) {
    ...
    public static Set<String> getExtensionsFormMimeTypes(Collection<String> mimeTypes, boolean defaultToMimeIfNotFound) {
        return mimeTypes
                .stream()//TODO vinicius.nunes, favor efetuar manutenção neste código
//                .map(s -> defaultToMimeIfNotFound ? MimeTypes.getExtensionsForMimeType(s, s) : MimeTypes.getExtensionsForMimeType(s, s))
                .map(s -> MimeTypes.getExtensionsForMimeType(s, s))
    ...
    protected static void buildMimeTypes3(ImmutableMultimap.Builder<String, String> builder) {
        builder
    ...
    protected static void buildMimeTypes2(ImmutableMultimap.Builder<String, String> builder) {
        builder
    ...
    protected static void buildMimeTypes1(ImmutableMultimap.Builder<String, String> builder) {
        builder
