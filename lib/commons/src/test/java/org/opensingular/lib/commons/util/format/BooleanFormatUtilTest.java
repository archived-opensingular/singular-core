...
public class BooleanFormatUtilTest {

    @Test
    public void booleanDescriptionTest() {
        String resultado  = FormatUtil.booleanDescription(true, "Verdadeiro", "Falso");
    ...
    @Test
    public void booleanDescriptionWhenBooleanIsNullTest() {
