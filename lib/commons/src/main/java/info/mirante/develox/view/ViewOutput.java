...
public abstract class ViewOutput {
    ...
    /**
     * Indica se o utilitario de CSS trocara o class CSS pelo equivante HTML.
     */
    private boolean expandirTagsCSS_ = false;

    private String urlApp_;

    private CSSUtil css_;
    ...
    public void copiarConfig(ViewOutput vOut) {
        ...
        expandirTagsCSS_ = vOut.expandirTagsCSS_;
        css_ = vOut.css_;
    ...
    /**
     * Indica que o m�todo getUtilCSS ser� configurado para converter as tags
     * CSS pelo equivalente em HTML. O default � n�o converter (false).
     */
    public void setExpandirTagsCSS(boolean valor) {
        expandirTagsCSS_ = valor;
        if (css_ != null) {
            css_.setExpandirTags(expandirTagsCSS_);
        }
    }

    public boolean isExpandirTagsCSS() {
        return expandirTagsCSS_;
    }
    ...
    public void setCss(CSSUtil css) {
        css_ = css;
        if (css_ != null) {
            css_.setExpandirTags(expandirTagsCSS_);
        }
