...
/**
 * Exceção para ser utilizada quando um serviço lança uma {@link SOAPFaultException}
 */
public class WSFaultException extends SingularException {
    ...
    public static WSFaultException rethrow(String message, SOAPFaultException e) {
        return new WSFaultException(message, e);
    }

    @Override
    public synchronized SOAPFaultException getCause() {
        return (SOAPFaultException) super.getCause();
    }
}
