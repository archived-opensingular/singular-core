package br.net.mirante.singular.support.persistence.enums;
...
public enum SimNao implements EnumId<SimNao, String> {
    ...
    public static final String ENUM_CLASS_NAME = "br.net.mirante.singular.support.persistence.enums.SimNao";
