 ...
 * </ul>
 */
public class SingularCsrfPreventionRequestCycleListener extends AbstractRequestCycleListener
        implements
        IRequestCycleListener
{
    private static final Logger log = LoggerFactory
            .getLogger(SingularCsrfPreventionRequestCycleListener.class);
