...
function createBelverMap(idMetadados) {
    ...
    if (typeof google != 'undefined') {
        ...
        $.getScript('https://maps.googleapis.com/maps/api/js?key='+googleMapsKey, createBelverMapImpl);
    }
    ...
    function createBelverMapImpl() {
        ...
        if (!JSON.parse(metadados.readOnly)) {
            ...
            $("#"+metadados.idLat).blur(defineMarkerPositionManual);
            $("#"+metadados.idLng).blur(defineMarkerPositionManual);
        }
