...
public class DefaulSingularWebResourcesFactory implements SingularWebResourcesFactory {
    ...
    protected Set<String> getStylePaths() {
        ...
        paths.add("global/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css");
        paths.add("global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.css");
        paths.add("global/plugins/bootstrap-select/css/bootstrap-select.css");
        paths.add("global/plugins/bootstrap-switch/css/bootstrap-switch.css");
        paths.add("global/plugins/jstree/dist/themes/default/style.css");
        ...
        paths.add("global/plugins/bootstrap-toastr/toastr.css");
